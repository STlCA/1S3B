        ...
        if (other.gameObject.tag.Contains("Player"))
        {
            switch (type)
            {
                case MapTriggerType.Farm_FarmRoad:
                    ...
                    gameManager.playerMap = PlayerMap.FarmRoad;
                    break;
                ...
                case MapTriggerType.Forest_BossRoom:
                    ...
                    gameManager.playerMap = PlayerMap.BossRoom;
                    break;
                ...
                case MapTriggerType.Town_TownRoad:
                    ...
                    gameManager.playerMap = PlayerMap.TownRoad;
                    break;
                ...
                case MapTriggerType.Beach_BeachL:
                    ...
                    gameManager.playerMap = PlayerMap.BeachL;
                    break;
