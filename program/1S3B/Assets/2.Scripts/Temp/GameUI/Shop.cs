...
public class Shop : MonoBehaviour, IObjectEvent, IItemPanel
{
    ...
    public void LoadItem()
    {
        ...
        for (int i = 0; i < shopItems.Length; i++)
        {
            ...
            //shopItem.transform.GetChild(1).GetComponent<TextMeshProUGUI>().text = shopItem.GetComponent<RectTransform>().sizeDelta.x.ToString(); // �̸�
            //shopItem.transform.GetChild(2).GetComponent<TextMeshProUGUI>().text = gameManager.panel_shop.GetComponent<RectTransform>().sizeDelta.x.ToString(); // ����

            shopItem.transform.GetChild(1).GetComponent<TextMeshProUGUI>().text = itemImg.koreanName; // �̸�
            shopItem.transform.GetChild(2).GetComponent<TextMeshProUGUI>().text = $"{splitShopItem[1]} $"; // ����
